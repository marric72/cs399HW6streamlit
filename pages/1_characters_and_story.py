...
data = {
    ...
    'Column 2': ['Freshman from Los Angela California; Asian Studies major, extroverted; likes computer games; Desired work related to Asian Studies. ',
                 'Junior student from New York. Chinese major. Enjoys playing basketball and singing. Hopes to work in China in the future.',
                 ...
                 'Junior student, from Houston. Cybersecurity major, enjoys cooking and traveling. Hope to work in cybersecurity in the future.'],
     'Column 3': ['Melissa.png', 'Jade.png', 'Mei.png', 'Diego.png']
}
df = pd.DataFrame(data)
# Display the table with images and text side by side
for index, row in df.iterrows():
    st.write("---")
    col1, col2 = st.columns([1, 3])  # Define column widths
    with col1:
        st.image(row['Column 3'], width=150, caption=row['Column 1'])
    with col2:
